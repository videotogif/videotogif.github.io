...
category: "개발기"
tags: [gifski, 프레임별팔레트, 시간축디더링, 고화질GIF, GIF혁신, 인코더, 색감개선]
excerpt: "프레임별 팔레트 최적화와 시간축 디더링으로 256색 제한을 돌파한 gifski 기술 분석. FFmpeg와의 차이점과 이 기술을 활용한 브라우저 기반 GIF 변환 사이트 소개"
description: "gifski 기술 분석과 FFmpeg와의 차이점"
image: /assets/img/post-bunny.jpg
---
...
🔗 **[ZIF - 브라우저 기반 고품질 GIF 변환기](https://videotogif.github.io/)**

'gifski'라는 기술을 사용해서 동영상을 훌륭한 품질의 GIF로 변환할 수 있는데요, <br>
이 기술이 궁금하시다면 아래 글을 읽어봐 주세요! 😀
...
![gifski 예시 gif](/assets/img/post05_1.gif)
...
![libimagequant란](/assets/img/post05_2.png)
...
![libimagequant](/assets/img/post05_3.png)
...
![나이브 양자화 예시](/assets/img/post05_4.png)
...
![libimagequant 양자화 예시](/assets/img/post05_5.png)
...
![Importance Map](/assets/img/post05_6.png)
...
![gifski](/assets/img/post05_7.gif)
...
**2) ffmpeg.gif**
![ffmpeg_gif](/assets/img/post05_8.gif)
...
![naver_gif](/assets/img/post05_9.gif)
...
![FFmpeg vs gifski 비교](/assets/img/post05_10.gif)
![FFmpeg_Gifski](/assets/img/post05_11.gif)
...
![gifski 단점](/assets/img/post05_12.png)
