---
layout: post
title: "내가 GIF 변환 도구를 만든이유"
date: 2025-01-10 09:00:00 +0900
category: "소개"
tags: [GIF변환기, 개발스토리, 브라우저기반, videotogif]
excerpt: "내가 더 잘하겠는데? 개발자가 직접 겪은 불편함을 해결하기 위해 만든 브라우저 기반 Video to GIF 변환기의 탄생 배경"
description: "개발자가 직접 겪은 불편함을 해결하기 위해 만든 브라우저 기반 Video to GIF 변환기의 탄생 배경"
...
키워드는 **ffmpeg.wasm** 입니다.
C로 작성된 ffmpeg를 WebAssembly로 컴파일한 라이브러리를 사용합니다.
개인적으로 이 부분은 제대로 설명하고 싶기 때문에 다음 포스팅에서 자세히 설명해 보겠습니다.^^
